...
?>
    ...
    if(isset($_GET['value'])){
        ...
        echo '<div style="margin-left: 350px;color: blue;">Legenda:</br>Na tej stronie klikając na odpowiadający dzień przyjęć oznaczony kolorem zielonym możesz usunąć go z systemu.</div>';
        
    }else{echo '<div style="margin-left: 350px;color: blue;">Legenda:</br>Na tej stronie klikając na odpowiadający dzień oznaczony kolorem zielonym możesz podejrzeć godziny pracy w tym dniu.</div>';}
    ?>
</body>
</html> 
<?php
if(isset($_GET['value'])){
        ...
        if($value == "alert")
        {
            echo '<script>alert("Nie mozna usunac dnia, który jest datą przeszłą, lub w ktorym sa zapisani pacjenci")</script>';
        }
}
?>